...
btn_generate.addEventListener('click', (e) => {
	eventBus.emit('generator:generate');
});

// Seed field
const gen_seed = document.getElementById('gen_seed');
gen_seed.addEventListener('input', (e) => {
	eventBus.emit('generator:settings_seed', { data: e.currentTarget.value });
});
...
gen_force_habitable.addEventListener('input', (e) => {
	eventBus.emit('generator:settings_force_habitable', { data: e.currentTarget.checked });
});
...
gen_life_chance.addEventListener('input', (e) => {
	eventBus.emit('generator:settings_life_chance', { data: Number(e.currentTarget.value) });
});
...
gen_jupiter_behavior_opt_random.addEventListener('input', (e) => {
	eventBus.emit('generator:settings_life_jupiter_behavior', { data: e.currentTarget.value });
});
...
gen_planet_density.addEventListener('input', (e) => {
	eventBus.emit('generator:settings_planet_density', { data: Number(e.currentTarget.value) });
});
...
gen_star_mass_min.addEventListener('input', (e) => {
	eventBus.emit('generator:settings_star_mass_min', { data: Number(e.currentTarget.value) });
});
...
gen_star_mass_max.addEventListener('input', (e) => {
	eventBus.emit('generator:settings_star_mass_max', { data: Number(e.currentTarget.value) });
});
...
gen_star_mass_use_imf.addEventListener('input', (e) => {
	eventBus.emit('generator:settings_star_mass_use_imf', { data: e.currentTarget.checked });
});
...
gen_star_metallicity_min.addEventListener('input', (e) => {
	eventBus.emit('generator:settings_star_metallicity_min', { data: Number(e.currentTarget.value) });
});
...
gen_star_metallicity_max.addEventListener('input', (e) => {
	eventBus.emit('generator:settings_star_metallicity_max', { data: Number(e.currentTarget.value) });
});
...
gen_star_metallicity_use_gaussian.addEventListener('input', (e) => {
	eventBus.emit('generator:settings_star_metallicity_use_gaussian', { data: e.currentTarget.checked });
});
...
gen_star_metallicity_mean.addEventListener('input', (e) => {
	eventBus.emit('generator:settings_star_metallicity_mean', { data: Number(e.currentTarget.value) });
});
...
gen_star_metallicity_std.addEventListener('input', (e) => {
	eventBus.emit('generator:settings_star_metallicity_std', { data: Number(e.currentTarget.value) });
});
